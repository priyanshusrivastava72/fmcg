...
const products = [
  ...
  { id: 12, name: "IT'S Magic Hot 'n Spicy", category: "Biscuits & Snacks", catId: 'snacks', img: p12 },
  ...
  { id: 16, name: "Paru Ultra White Detergent", category: "Home Care", catId: 'home', img: p16 },
  { id: 17, name: "Paru Daily Wash Detergent", category: "Home Care", catId: 'home', img: p17 },
          ...
          <AnimatePresence mode='popLayout'>
            {displayProducts.map((product) => (
              <motion.div
                ...
                className="bg-white rounded-[32px] p-6 border border-gray-100 shadow-sm hover:shadow-xl transition-all group flex flex-col items-center text-center relative overflow-hidden"
              >
                <div className="h-48 w-full mb-6 flex items-center justify-center p-4">
                  <img 
                    src={product.img} 
                    alt={product.name} 
                ...
                <div className="space-y-1 w-full text-left px-2">
                  <h4 className="text-base font-black text-gray-900 line-clamp-1">{product.name}</h4>
